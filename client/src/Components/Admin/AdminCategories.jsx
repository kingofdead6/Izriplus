...
const S = {
  ...
  h1: { fontFamily: "'Playfair Display'", fontWeight: 700, fontSize: "clamp(28px,4vw,52px)", color: "var(--ink)", margin: "0 0 8px", letterSpacing: "-.02em" },
  subtitle: { color: "var(--muted)", fontSize: 15, margin: "0 0 36px" },
  toolbar: { display: "flex", flexWrap: "wrap", gap: 12, marginBottom: 36 },
  addBtn: { display: "flex", alignItems: "center", gap: 9, padding: "13px 24px", background: "linear-gradient(135deg,var(--secondary),var(--primary))", color: "#fff", border: "none", borderRadius: 14, fontFamily: "'Inter'", fontWeight: 700, fontSize: 15, cursor: "pointer", whiteSpace: "nowrap" },
  searchWrap: { position: "relative", flex: "1 1 220px" },
  searchIcon: { position: "absolute", left: 14, top: "50%", transform: "translateY(-50%)", color: "var(--muted)", pointerEvents: "none" },
  searchInput: { width: "100%", padding: "13px 14px 13px 42px", background: "var(--surface-soft)", border: "1px solid var(--line)", borderRadius: 12, color: "var(--ink)", fontSize: 15, outline: "none", fontFamily: "inherit", boxSizing: "border-box" },
  grid: { display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(220px,1fr))", gap: 18 },
  card: { background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 20, overflow: "hidden", display: "flex", flexDirection: "column", transition: "border-color .2s, box-shadow .2s, transform .2s", cursor: "default", position: "relative" },
  ...
  cardName: { fontFamily: "'Playfair Display'", fontWeight: 700, fontSize: 16, color: "var(--ink)", margin: 0 },
  cardDesc: { fontSize: 12, color: "var(--muted)", margin: 0, lineHeight: 1.4, display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical", overflow: "hidden" },
  ...
  modal: { background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 24, width: "100%", maxWidth: 520, maxHeight: "85vh", display: "flex", flexDirection: "column", boxShadow: "0 24px 80px rgba(43,33,24,.22)" },
  ...
  label: { fontSize: 11, color: "var(--muted)", fontFamily: "'Inter'", fontWeight: 600, textTransform: "uppercase", letterSpacing: ".06em", marginBottom: 6, display: "block" },
  input: { padding: "13px 16px", background: "var(--surface-soft)", border: "1px solid var(--line)", borderRadius: 12, color: "var(--ink)", fontSize: 15, outline: "none", fontFamily: "inherit", width: "100%", boxSizing: "border-box" },
  textarea: { padding: "13px 16px", background: "var(--surface-soft)", border: "1px solid var(--line)", borderRadius: 12, color: "var(--ink)", fontSize: 15, outline: "none", fontFamily: "inherit", width: "100%", minHeight: 80, resize: "vertical", boxSizing: "border-box" },
  ...
  submitBtn: { flex: 1, padding: "14px", background: "linear-gradient(135deg,var(--secondary),var(--primary))", color: "#fff", border: "none", borderRadius: 12, fontFamily: "'Inter'", fontWeight: 700, fontSize: 15, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 },
  cancelBtn: { flex: 1, padding: "14px", background: "var(--surface-soft)", border: "1px solid var(--line)", color: "var(--muted)", borderRadius: 12, fontFamily: "'Inter'", fontWeight: 700, fontSize: 15, cursor: "pointer" },
};
            ...
            {filtered.map((cat, i) => (
              <motion.div
                ...
                onMouseEnter={e => {
                  ...
                  e.currentTarget.style.boxShadow = "0 12px 40px rgba(43,33,24,.16)";
                ...
                <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                  ...
                  <div>
                    ...
                    <label style={S.fileZone}>
                      ...
                      <span style={{ display: "block", fontSize: 12, color: "var(--muted)", marginTop: 4 }}>Recommended: 800×600px</span>
                    </label>
                    {imagePreview && (
