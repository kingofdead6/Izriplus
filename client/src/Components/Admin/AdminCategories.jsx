...
const S = {
  ...
  h1: { fontFamily: "'Fraunces'", fontWeight: 700, fontSize: "clamp(28px,4vw,52px)", color: "var(--ink)", margin: "0 0 8px", letterSpacing: "-.02em" },
  ...
  cardName: { fontFamily: "'Fraunces'", fontWeight: 700, fontSize: 16, color: "var(--ink)", margin: 0 },
