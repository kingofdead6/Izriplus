...
const S = {
  ...
  infoBox: { background: "var(--surface-soft)", border: "1px solid var(--line)", borderRadius: 12, padding: "12px 14px" },
  infoLabel: { fontSize: 11, color: "var(--muted)", fontFamily: "'Inter'", fontWeight: 600, textTransform: "uppercase", letterSpacing: ".06em", marginBottom: 4 },
  infoVal: { fontSize: 14, color: "var(--ink)", fontWeight: 500, margin: 0 },
  msgText: { fontSize: 14, color: "var(--ink)", lineHeight: 1.75, whiteSpace: "pre-wrap", background: "var(--surface-soft)", border: "1px solid var(--line)", borderRadius: 12, padding: "14px 16px" },
};
          ...
          <div style={S.grid}>
            {messages.map((msg, i) => (
              <motion.div
                ...
                style={S.card}
                onMouseEnter={e => { e.currentTarget.style.borderColor = "rgb(var(--accent-rgb) / .25)"; e.currentTarget.style.boxShadow = "0 12px 40px rgba(43,33,24,.16)"; }}
